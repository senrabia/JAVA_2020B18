...
public class AStringContinue_Explain {
...
String methods:
        ...
        indexOf(Value): returns the index number of first occured character, as int
        lastIndexOf(Value): return the index number of last occured character, as int
