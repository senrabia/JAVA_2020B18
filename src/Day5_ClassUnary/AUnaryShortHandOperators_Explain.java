...
public class AUnaryShortHandOperators_Explain {
...
primitive castings: casting larger primitives to smaller sizes, or casting smaller primitives to larger sizes
...
two types of increment/decrement:
        pre: increases the value of the variable by 1 immediately,
                int a =100;
                ++a; // a = 101
                int b = 100;
                --b; // b = 99
        post: increases/decrease the value by 1 not immediately
            first passes the current value, and then increases/decrease the value by one
                int A =100;
                    A++;
                int B = 100;
                    B--;
