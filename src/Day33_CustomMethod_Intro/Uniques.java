...
public class Uniques {
  /* 1. write a program that can return the unique objects from a anArray List of Integers
    ...
    removeIf( frequency > 1)  can keep the unique objects in arrayList  remove unique
        */
  public static void main(String[] args) {

      ArrayList<Integer> list=new ArrayList<>();
      list.addAll(Arrays.asList(1,1,2,3,4,5,5));
     // list.removeIf(p-> Collections.frequency(list, p));  //give me eror
      list.removeIf(p-> Collections.frequency(list, p)>1);   //if the frequency of object is grater than one we remove.
      System.out.println(list);
    //======What if I ask remove the uniques.==========
