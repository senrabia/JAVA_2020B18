...
public class AStaticBloc_Explain {
   /* 05/08/2020
    Topics: Static Block
    Static Import
    multi-classes
    Package Name: day36_StaticBlock
    ...
    multi-class: we can have multiple classes in a same java file, as long as there is only one public class
    public class' name MUST be same with the file name
    Next week: Instance Block: for initializing instance variables
            Constructor
    OOP: Encapsulation
    summary:
