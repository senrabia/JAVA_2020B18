...
public class Pet {
  ...
  public void eat(String food){ //Not used static.
 ...
 public void sleep(String place) {
     System.out.println(name+" is sleaping "+place);

 }
 public String toString(){
    return "name "+name+", age "+age+",  color"+color+", size "+size+", breed "+breed+isPet+numberOfEyes;
