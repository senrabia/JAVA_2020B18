...
public class AStringManipulation_Explain {
...
String manipulations:
        ...
        substring(beginning index): creates substring of the string value from the beginning index till the end of the string
