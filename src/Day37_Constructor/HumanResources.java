...
public class HumanResources {
  ...
  /*  public static void main(String[] args) {  //PSVM is that close but Bank of Azerbaijan working...
        //Stati9c Block V -
    ...
    //Can I diclared the static block where is the place, not important lbefore or after
    static {
        employee1.setInfo("Zuleyha",1254,45874641,"QA",110000,'F');
        employee2.setInfo("Kyle", 1123, 112345678, "SDET", 110000, 'M');
        employee3.setInfo("Marina", 1124, 111234567, "Product Manager", 170000, 'F');
